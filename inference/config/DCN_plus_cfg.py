...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/home/fpares/prima_projects/delorian_claim/the_delorian_claim_ml/data/CarDD_COCO/',
        pipeline=[
...
test_evaluator = dict(
    ann_file=
    '/home/fpares/prima_projects/delorian_claim/the_delorian_claim_ml/data/CarDD_COCO/annotations/instances_val2017.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFile'),
    dict(
        backend='pillow', keep_ratio=False, scale=(
            1000,
            667,
        ), type='Resize'),
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
